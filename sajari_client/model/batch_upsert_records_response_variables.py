...
class BatchUpsertRecordsResponseVariables(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """BatchUpsertRecordsResponseVariables - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            index (int): Index of the record in `records` that these variables correspond to.. [optional]  # noqa: E501
            variables ({str: ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},)}): The variables.. [optional]  # noqa: E501
        """

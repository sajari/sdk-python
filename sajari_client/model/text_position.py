...
class TextPosition(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if 'value' in kwargs:
            ...
            value = "TEXT_POSITION_UNSPECIFIED"

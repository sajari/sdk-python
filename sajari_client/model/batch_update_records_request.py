...
class BatchUpdateRecordsRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'requests': ([UpdateRecordRequest],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, requests, *args, **kwargs):  # noqa: E501
        """BatchUpdateRecordsRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, requests, *args, **kwargs):  # noqa: E501
        """BatchUpdateRecordsRequest - a model defined in OpenAPI

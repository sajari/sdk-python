...
class SetDefaultPipelineRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, pipeline, type, *args, **kwargs):  # noqa: E501
        """SetDefaultPipelineRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, pipeline, type, *args, **kwargs):  # noqa: E501
        """SetDefaultPipelineRequest - a model defined in OpenAPI

...
class Promotion(ModelNormal):
    ...
    def _from_openapi_data(cls, condition, display_name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            collection_id (str): Output only. The ID of the collection that owns this promotion.. [optional]  # noqa: E501
            create_time (datetime): Output only. Time the promotion was created.. [optional]  # noqa: E501
            ...
            update_time (datetime): Output only. Time the promotion was last updated.. [optional]  # noqa: E501
        """

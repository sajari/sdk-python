...
class SendEventRequest(ModelNormal):
    ...
    def __init__(self, name, token, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            weight (int): The weight assigned to the event.  Generally a sensible weight is 1. If you want to weight an event in a certain way you can use a value other than 1. For example, if you want to capture profit in an event, you could set the weight to a value that represents the profit.. [optional]  # noqa: E501

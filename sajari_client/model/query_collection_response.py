...
def lazy_import():
    ...
    globals()['ActivePromotion'] = ActivePromotion
    ...
    globals()['RedirectResult'] = RedirectResult


class QueryCollectionResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'active_promotions': ([ActivePromotion],),  # noqa: E501
            'aggregate_filters': ({str: (QueryAggregateResult,)},),  # noqa: E501
            'aggregates': ({str: (QueryAggregateResult,)},),  # noqa: E501
    ...
    attribute_map = {
        'active_promotions': 'active_promotions',  # noqa: E501
        'aggregate_filters': 'aggregate_filters',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """QueryCollectionResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            active_promotions ([ActivePromotion]): A list of the promotions activated when running the query.. [optional]  # noqa: E501
            aggregate_filters ({str: (QueryAggregateResult,)}): The aggregates run with filters.. [optional]  # noqa: E501
            aggregates ({str: (QueryAggregateResult,)}): The aggregates returned by the query.. [optional]  # noqa: E501
            banners ([Banner]): Banners associated with this query.. [optional]  # noqa: E501
            ...
            variables ({str: ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},)}): The modified variables returned by the pipeline after it has finished processing.. [optional]  # noqa: E501
        """

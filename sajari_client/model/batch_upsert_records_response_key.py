...
class BatchUpsertRecordsResponseKey(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """BatchUpsertRecordsResponseKey - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            index (int): Index of the record in `records` that this key corresponds to.. [optional]  # noqa: E501

...
class SchemaFieldType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Type represents the underlying data type of the field. Type is required and cannot be unspecified.   - STRING: String values.  - INTEGER: Integer values (64-bit).  - FLOAT: Floating point values (32-bit).  - DOUBLE: Double floating point values (64-bit).  - BOOLEAN: Boolean values.  - TIMESTAMP: Timestamp values.  - BYTES: Raw byte values.. if omitted defaults to "TYPE_UNSPECIFIED", must be one of ["TYPE_UNSPECIFIED", "STRING", "INTEGER", "FLOAT", "DOUBLE", "BOOLEAN", "TIMESTAMP", "BYTES", ]  # noqa: E501

...
class BatchUpsertRecordsResponse(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """BatchUpsertRecordsResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            keys ([BatchUpsertRecordsResponseKey]): A list of keys of the records that were inserted.  If a record was inserted, keys contains an entry containing the index of the inserted record from `records` and the key. You can use the key if you need to retrieve or delete the record.  If a record was updated, keys contains no such entry for the updated record.. [optional]  # noqa: E501
            variables ([BatchUpsertRecordsResponseVariables]): A list of modified variables returned by the pipeline after it has finished processing each record.. [optional]  # noqa: E501

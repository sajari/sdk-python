...
class SchemaField(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, mode, name, type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            array (bool): Array indicates if the field is an array of values.  For example, if `type` is string and `array` is `true`, then the field is an array of strings.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, mode, name, type, *args, **kwargs):  # noqa: E501
        """SchemaField - a model defined in OpenAPI

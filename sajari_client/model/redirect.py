...
class Redirect(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, condition, target, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            collection_id (str): Output only. The ID of the collection that owns this redirect.. [optional]  # noqa: E501
            create_time (datetime): Output only. Time the redirect was created.. [optional]  # noqa: E501
            disabled (bool): If disabled, the redirect is never triggered.. [optional]  # noqa: E501
            id (str): Output only. The redirect's ID.. [optional]  # noqa: E501
            update_time (datetime): Output only. Time the redirect was last updated.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, condition, target, *args, **kwargs):  # noqa: E501
        """Redirect - a model defined in OpenAPI

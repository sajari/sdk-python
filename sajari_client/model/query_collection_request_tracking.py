...
class QueryCollectionRequestTracking(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            query_id (str): Query ID of the query. If this is empty, then one is generated.. [optional]  # noqa: E501
            sequence (int): Sequence number of query.. [optional]  # noqa: E501
            field (str): Tracking field used to identify records in the collection.  Must be unique schema field.. [optional]  # noqa: E501
            data ({str: (str,)}): Custom values to be included in tracking data.. [optional]  # noqa: E501
        """

...
class BatchUpdateRecordsResponseError(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """BatchUpdateRecordsResponseError - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            index (int): The index of the record in `requests` that this error corresponds to.. [optional]  # noqa: E501

...
class Pipeline(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, type, version, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            collection_default (bool): Indicates if the pipeline is the collection default pipeline.. [optional]  # noqa: E501
            create_time (datetime): The time the pipeline was created.. [optional]  # noqa: E501
            default_version (bool): Indicates if the pipeline is the default version.. [optional]  # noqa: E501
            ...
            pre_steps ([PipelineStep]): The pre-steps that are run before an indexing operation or query request is sent to the search index.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, type, version, *args, **kwargs):  # noqa: E501
        """Pipeline - a model defined in OpenAPI

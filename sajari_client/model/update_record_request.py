...
class UpdateRecordRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'record': ({str: ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},)},),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, record, update_mask, *args, **kwargs):  # noqa: E501
        """UpdateRecordRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, record, update_mask, *args, **kwargs):  # noqa: E501
        """UpdateRecordRequest - a model defined in OpenAPI

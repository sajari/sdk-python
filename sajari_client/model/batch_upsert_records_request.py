...
class BatchUpsertRecordsRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'pipeline': (BatchUpsertRecordsRequestPipeline,),  # noqa: E501
    ...
    def _from_openapi_data(cls, records, *args, **kwargs):  # noqa: E501
        """BatchUpsertRecordsRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            pipeline (BatchUpsertRecordsRequestPipeline): [optional]  # noqa: E501
            variables ({str: ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},)}): The initial values for the variables the pipeline operates on and transforms throughout its steps.. [optional]  # noqa: E501
        """

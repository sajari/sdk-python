...
class RecordsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.batch_update_records_endpoint = _Endpoint(
            settings={
                'response_type': (BatchUpdateRecordsResponse,),
                'auth': [
                    'BasicAuth'
                ],
                'endpoint_path': '/v4/collections/{collection_id}/records:batchUpdate',
                'operation_id': 'batch_update_records',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'collection_id': 'path',
                    'batch_update_records_request': 'body',
                },
        ...
        self.batch_upsert_records_endpoint = _Endpoint(
            settings={
        ...
        self.delete_record_endpoint = _Endpoint(
            settings={
        ...
        self.get_record_endpoint = _Endpoint(
            settings={
        ...
        self.update_record_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/v4/collections/{collection_id}/records:update',
        ...
        self.upsert_record_endpoint = _Endpoint(
            settings={
    ...
    def batch_update_records(
        ...
        **kwargs
        ...
        """Batch update records  # noqa: E501

        The batch version of the [UpdateRecord](/docs/api#operation/UpdateRecord) call.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.batch_update_records(collection_id, batch_update_records_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['collection_id'] = \
            collection_id
        kwargs['batch_update_records_request'] = \
            batch_update_records_request
        return self.batch_update_records_endpoint.call_with_http_info(**kwargs)
    ...
    def batch_upsert_records(
        ...
        **kwargs
        ...
        The batch version of the [UpsertRecord](/docs/api#operation/UpsertRecord) call.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['batch_upsert_records_request'] = \
            batch_upsert_records_request
        return self.batch_upsert_records_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_record(
        ...
        **kwargs
        ...
        kwargs['delete_record_request'] = \
            delete_record_request
        return self.delete_record_endpoint.call_with_http_info(**kwargs)
    ...
    def get_record(
        ...
        **kwargs
        ...
        kwargs['get_record_request'] = \
            get_record_request
        return self.get_record_endpoint.call_with_http_info(**kwargs)
    ...
    def update_record(
        ...
        **kwargs
        ...
        Add or update specific fields within a record with the given values. The updated record is returned in the response.  To replace all fields in a record, you should use the [UpsertRecord](/docs/api#operation/UpsertRecord) call.  Note that the update record call cannot be used to add or update indexed or unique fields. For this case use the [UpsertRecord](/docs/api#operation/UpsertRecord) call.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_record(collection_id, update_record_request, async_req=True)
        >>> result = thread.get()
    ...
    def upsert_record(
        ...
        **kwargs
        ...
        kwargs['upsert_record_request'] = \
            upsert_record_request
        return self.upsert_record_endpoint.call_with_http_info(**kwargs)

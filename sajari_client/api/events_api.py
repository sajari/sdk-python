...
class EventsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.send_event_endpoint = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [
                    'BasicAuth'
                ],
                'endpoint_path': '/v4/events:send',
        ...
        self.send_event2_endpoint = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [
                    'BasicAuth'
    ...
    def send_event(
        ...
        **kwargs
        ...
        kwargs['send_event_request'] = \
            send_event_request
        return self.send_event_endpoint.call_with_http_info(**kwargs)
    ...
    def send_event2(
        ...
        **kwargs
        ...
        >>> thread = api.send_event2(send_event_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['send_event_request'] = \
            send_event_request
        return self.send_event2_endpoint.call_with_http_info(**kwargs)

...
class PipelinesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_pipeline_endpoint = _Endpoint(
            settings={
        ...
        self.generate_pipelines_endpoint = _Endpoint(
            settings={
        ...
        self.get_default_pipeline_endpoint = _Endpoint(
            settings={
        ...
        self.get_default_version_endpoint = _Endpoint(
            settings={
                'response_type': (Pipeline,),
                'auth': [
                    'BasicAuth'
        ...
        self.set_default_pipeline_endpoint = _Endpoint(
            settings={
        ...
        self.set_default_version_endpoint = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [
                    'BasicAuth'
    ...
    def create_pipeline(
        ...
        **kwargs
        ...
        kwargs['pipeline'] = \
            pipeline
        return self.create_pipeline_endpoint.call_with_http_info(**kwargs)
    ...
    def generate_pipelines(
        ...
        **kwargs
        ...
        kwargs['generate_pipelines_request'] = \
            generate_pipelines_request
        return self.generate_pipelines_endpoint.call_with_http_info(**kwargs)
    ...
    def get_default_pipeline(
        ...
        **kwargs
        ...
        Args:
            ...
            type (str): The type of the pipeline to get.   - RECORD: Record pipeline.  - QUERY: Query pipeline.. defaults to "TYPE_UNSPECIFIED", must be one of ["TYPE_UNSPECIFIED"]
        ...
        kwargs['type'] = \
            type
        return self.get_default_pipeline_endpoint.call_with_http_info(**kwargs)
    ...
    def get_default_version(
        ...
        **kwargs
        ...
        kwargs['name'] = \
            name
        return self.get_default_version_endpoint.call_with_http_info(**kwargs)
    ...
    def list_pipelines(
        ...
        **kwargs
        ...
        Retrieve a list of pipelines in a collection.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def set_default_pipeline(
        ...
        **kwargs
        ...
        kwargs['set_default_pipeline_request'] = \
            set_default_pipeline_request
        return self.set_default_pipeline_endpoint.call_with_http_info(**kwargs)
    ...
    def set_default_version(
        ...
        **kwargs
        ...
        kwargs['set_default_version_request'] = \
            set_default_version_request
        return self.set_default_version_endpoint.call_with_http_info(**kwargs)
